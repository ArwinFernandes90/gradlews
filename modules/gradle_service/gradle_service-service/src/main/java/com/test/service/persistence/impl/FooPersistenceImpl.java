...
import com.test.service.persistence.impl.constants.SEPersistenceConstants;
...
public class FooPersistenceImpl
	...
	@Override
	@Reference(
		target = SEPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = SEPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
	...
	static {
		try {
			Class.forName(SEPersistenceConstants.class.getName());
		}
